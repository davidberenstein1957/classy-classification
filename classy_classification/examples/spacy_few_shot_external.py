...
nlp = spacy.blank("en")
nlp.add_pipe("classy_classification", config={"data": training_data, "include_sent": True})
print([sent._.cats for sent in nlp(validation_data[0]).sents])
print([doc._.cats for doc in nlp.pipe(validation_data)])

nlp = spacy.blank("en")
nlp.add_pipe("classy_classification", config={"data": training_data, "include_doc": False, "include_spans": True})
print([doc._.cats for doc in nlp.pipe(validation_data)])
